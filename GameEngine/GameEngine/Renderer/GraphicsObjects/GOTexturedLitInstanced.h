#ifndef GOTEXTUREDLITINSTANCED_H
#define GOTEXTUREDLITINSTANCED_H
...
class GOTexturedLitInstanced : public GraphicsObject, public GOLit
{
public:
...
private:
	...
	GOTexturedLitInstanced() = delete;

	GOTexturedLitInstanced(const GOTexturedLitInstanced&) = delete;

	GOTexturedLitInstanced& operator=(const GOTexturedLitInstanced&) = delete;

	GOTexturedLitInstanced(GOTexturedLitInstanced&&) = delete;
...
#endif // GOTEXTUREDLITINSTANCED_H