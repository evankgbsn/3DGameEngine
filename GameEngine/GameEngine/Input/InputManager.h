...
public:
	...
	static void RegisterCallbackForMouseButtonState(int state, int mouseButton, std::function<void(int mouseButton)>* const callback, const std::string& name);
...
private:
	...
	std::unordered_map<int, std::unordered_map<std::string, std::function<void(int MouseButtonCode)>*>> registeredMouseButtonPressEvents;

	std::unordered_map<int, std::unordered_map<std::string, std::function<void(int MouseButtonCode)>*>> registeredMouseButtonReleaseEvents;
