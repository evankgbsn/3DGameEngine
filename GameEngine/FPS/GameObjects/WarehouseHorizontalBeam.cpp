...
{
	graphics = new GraphicsObjectTexturedLit(ModelManager::GetModel("WarehouseHorizontalBeam"), "WarehouseHorizontalBeam", "WarehouseHorizontalBeamSpec", "WarehouseHorizontalBeam");
