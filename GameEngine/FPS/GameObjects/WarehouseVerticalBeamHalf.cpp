...
{
	graphics = new GraphicsObjectTexturedLit(ModelManager::GetModel("WarehouseVerticalBeamHalf"), TextureManager::GetTexture("WarehouseVerticalBeamHalf"), TextureManager::GetTexture("WarehouseVerticalBeamHalfSpec"));
